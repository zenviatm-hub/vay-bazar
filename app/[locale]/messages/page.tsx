            ...
            {selectedConv ? (
                ...
                <div className="border-b bg-muted/30 p-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">{t("viewFullListing")}</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex flex-1 items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="mb-2 text-lg font-semibold text-foreground">{t("selectConversation")}</h3>
                  <p className="text-sm text-muted-foreground">{t("selectConversationDescription")}</p>
                </div>
              </div>
            )}
          </div>
