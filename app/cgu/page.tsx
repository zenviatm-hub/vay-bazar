...
export const metadata = {
  title: "Conditions Générales d'Utilisation - Vay Bazar",
  description: "Conditions d'utilisation de la plateforme Vay Bazar",
}
...
export default function CGUPage() {
  return (
    <div className="container mx-auto max-w-4xl px-4 py-8">
      ...
      <h1 className="mb-6 text-3xl font-bold text-foreground">Conditions Générales d'Utilisation</h1>
      ...
      <div className="mb-8 rounded-lg border border-primary/20 bg-primary/5 p-6">
        <div className="flex items-start gap-3">
          ...
          <p className="text-sm text-muted-foreground">
            En utilisant Vay Bazar, vous acceptez les présentes conditions d'utilisation. Veuillez les lire
            attentivement.
          </p>
        </div>
      </div>
