...
export const metadata = {
  title: "Politique de confidentialité - Vay Bazar",
  description: "Politique de confidentialité et protection des données personnelles sur Vay Bazar",
}
...
export default function PolitiqueConfidentialitePage() {
  return (
    <div className="container mx-auto max-w-4xl px-4 py-8">
      ...
      <h1 className="mb-6 text-3xl font-bold text-foreground">Politique de confidentialité</h1>

      <div className="mb-8 rounded-lg border bg-card p-6">
        <p className="text-muted-foreground">
          Chez Vay Bazar, nous prenons très au sérieux la protection de vos données personnelles. Cette politique
