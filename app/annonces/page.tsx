      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <h1 className="mb-2 text-3xl font-bold text-foreground">
            {categoryName ? `${categoryName}` : "Toutes les annonces"}
          </h1>
        ...
        <div className="mb-6 flex flex-col gap-4 rounded-xl border bg-card p-4 shadow-sm md:flex-row md:items-center">
          ...
          <Select value={sortBy} onValueChange={setSortBy}>
            ...
            <SelectContent>
              ...
              <SelectItem value="views">Plus populaire</SelectItem>
            </SelectContent>
          </Select>
            ...
            <SheetContent className="w-full overflow-y-auto sm:max-w-md">
              ...
              <div className="mt-6 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  {loadingCities ? (
                    <Input id="location-filter" placeholder="Chargement des villes..." disabled />
                  ) : cities.length === 0 ? (
                    <Input
                      id="location-filter"
        ...
        {filteredListings.length > 0 ? (
          ...
          <Card>
            <CardContent className="p-12 text-center">
              <p className="mb-2 text-lg text-muted-foreground">Aucune annonce trouvée</p>
              <p className="mb-4 text-sm text-muted-foreground">Essayez de modifier vos filtres de recherche</p>
