  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="mb-8">
          <h1 className="mb-4 text-3xl font-bold text-foreground">Avis et recommandations</h1>
        ...
        <div className="space-y-4">
          {userReviews.length === 0 ? (
            <div className="rounded-lg border bg-card p-12 text-center">
              ...
              <h3 className="mb-2 text-lg font-semibold text-foreground">Aucun avis pour le moment</h3>
              <p className="text-muted-foreground">Les premiers avis apparaîtront ici après les transactions.</p>
            </div>
          ) : (
