      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8 grid gap-8 lg:grid-cols-3">
            ...
            <Card className="sticky top-20">
              <CardContent className="p-6">
                <div className="mb-6 flex flex-col items-center text-center">
                  ...
                  <Badge variant="secondary">Membre de la communauté</Badge>
                </div>
                ...
                {stats.totalReviews > 0 && (
                  <Button asChild variant="outline" size="sm" className="mb-4 w-full bg-transparent">
                    <Link href={`/profil/${userId}/avis`}>Voir tous les avis</Link>
                  </Button>
                )}
                ...
                <div className="space-y-4">
                  {user.bio && (
                    <div>
                      <h3 className="mb-2 text-sm font-semibold text-foreground">À propos</h3>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      ...
                      <span>{userListings.length} annonces actives</span>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              <h2 className="mb-2 text-2xl font-bold text-foreground">Annonces de {user.first_name}</h2>
              <p className="text-muted-foreground">
                {userListings.length} {userListings.length > 1 ? "annonces actives" : "annonce active"}
              </p>
            </div>
            ...
            {userListings.length > 0 ? (
              ...
              <Card>
                <CardContent className="p-12 text-center">
                  <p className="text-lg text-muted-foreground">Aucune annonce active pour le moment</p>
                </CardContent>
              </Card>
            )}
          </div>
