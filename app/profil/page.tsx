...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto max-w-4xl px-4 py-8">
        <div className="mb-8">
          <h1 className="mb-2 text-3xl font-bold text-foreground">Mon profil</h1>
              ...
              <div className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Ajoutez une photo pour personnaliser votre profil</CardDescription>
                  </CardHeader>
                  <CardContent className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-xs text-muted-foreground">JPG, PNG jusqu&apos;à 5MB</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      {loadingCities ? (
                        <Input id="location" placeholder="Chargement des villes..." disabled className="pl-10" />
                      ) : cities.length === 0 ? (
                        <div className="relative">
                        ...
                        <div className="relative">
                          ...
                          >
                            <SelectTrigger id="location" className="pl-10">
                              <SelectValue placeholder={profile.location || "Sélectionnez votre ville"}>
                                {profile.location && cities.some(c => c.name === profile.location) 
                                  ? profile.location 
                                  : profile.location || "Sélectionnez votre ville"}
                              </SelectValue>
                            </SelectTrigger>
                          ...
                          {profile.location && !cities.some(c => c.name === profile.location) && (
                            <p className="text-xs text-muted-foreground mt-1">
                              Ville actuelle: {profile.location} (non trouvée dans la liste)
                            </p>
                          )}
                        </div>
                      )}
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        maxLength={500}
                      />
                      <p className="text-xs text-muted-foreground">{profile.bio.length}/500 caractères</p>
                    </div>
                  </CardContent>
                </Card>
